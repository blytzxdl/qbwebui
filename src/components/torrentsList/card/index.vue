          ...
          <div class="container2 col">
            ...
            <div class="baseInfo col">
              <div class="row text">
                <div class="row line">
                  <div
                    v-for="badge in cardBadge"
                    :key="badge.name"
                    class="container3"
                  >
                    <div v-if="badge.show" :class="badge.class">
                      <van-icon :name="badge.icon" v-if="badge.icon" />
                      {{ badge.content }}
                    </div>
                  </div>
                </div>
  ...
  computed: {
    ...
    cardBadge() {
      let cardBadge = {
        ...
        downloaded: {
          content: "D:" + this.torrentInfo.downloaded + "/",
          show: Boolean(this.swipe),
        },
        size: {
          content: "T:" + this.torrentInfo.size,
          show: true,
        },
        category: {
          content: this.torrentInfo.category,
          show: !this.swipe,
          icon: "apps-o",
        },
        ratio: {
          content: this.torrentInfo.ratio,
          show: !this.swipe,
          icon: "cluster-o",
        },
        tags: {
          content: this.torrentInfo.tags,
